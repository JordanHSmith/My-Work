...
class SpecialRotatingBlock(Thing):
	...
	def __init__(self,win, x0 = 0, y0 = 0, height = 1, width = 1, Ax = None, Ay = None,color = (100,0,0)):
		...
		self.points = [[0,-height/2],[width/1.25,-height/3],[width/1.25,height/3],[0,height/2]]
...
#### Provided for you!###########
	def render(self):
		...
		for vertex in self.points:
			...
			# self.point_x = self.scale*x
			# self.point_y = self.win.getHeight()-self.scale*y
			verticesX.append(self.scale*x)
			verticesY.append(self.win.getHeight()-self.scale*y)
		 
		#defines the block as a polygon wiith four vertices
		self.vis  = [gr.Polygon(pts[0],pts[1], pts[2], pts[3])]
		self.point_x = verticesX[3]
		self.point_y = verticesY[3]
		self.point_x2 = verticesX[0]
		self.point_y2 = verticesY[0]
	...
	def getPointX2(self):
		return self.point_x2

	def getPointY2(self):
		return self.point_y2
...
class RotatingBlock(Thing):
	...
	def __init__(self,win, x0 = 0, y0 = 0, height = 1, width = 1, Ax = None, Ay = None,color = (100,0,0)):
		...
		self.point_x = self.position[0] - width/2
		self.point_y = self.position[1] - height/2
