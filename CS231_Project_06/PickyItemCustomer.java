...
public class PickyItemCustomer extends Customer
{
    //Simulates a customer that always picks the shortest line
    public PickyItemCustomer(int numItems, int numLines)
    {
    ...
    public int chooseLine(ArrayList<CheckoutAgent> checkouts)
    {
        ...
        {
            if(checkoutArray[i].getNumItems() < shortest)
            {
                shortest = checkoutArray[i].getNumItems();
                shortestIndex = i;
            }
        }
    ...
    {
        PickyItemCustomer testCustomer = new PickyItemCustomer(10,3);
